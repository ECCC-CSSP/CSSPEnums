...
namespace CSSPEnums
{
    ...
    /// > [!NOTE]
    /// > 
    /// > <para>**Used by [CSSPModels](CSSPModels.html)** : [TVFile] (CSSPModels.TVFile.html#CSSPModels_TVFile_FileType)</para>
